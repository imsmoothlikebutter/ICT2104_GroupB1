...
int main(void)
{
    ...
    GPIO_setOutputLowOnPin(GPIO_PORT_P4, GPIO_PIN5);   // Setting P4.5 at a High State
    ...
    GPIO_setOutputLowOnPin(GPIO_PORT_P4, GPIO_PIN0);   // Setting P4.0 at a High State
...
void forwardDirection(void)
{
    ...
    pwmConfigLeftWheel.dutyCycle = 40000;
    ...
    pwmConfigRightWheel.dutyCycle = 40000;
...
{
    //Stop the left wheel
       pwmConfigLeftWheel.dutyCycle = 0;

    //Stop the right wheel
       pwmConfigRightWheel.dutyCycle = 0;
